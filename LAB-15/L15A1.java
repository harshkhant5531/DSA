public class L15A1 {
	...
	// A recursive function to construct Full from pre[] and post[]. preIndex is used
	// to keep track of index in pre[]. l is low index and h is high index for the current subarray in post[]
	static node constructTreeUtil(int pre[], int post[], int l, int h, int size) {
		...
		// If the current subarray has only one element, no need to recur or
